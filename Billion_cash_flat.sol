...
contract BillionCash is Ownable {
    ...
    uint256 public constant BURN_PERCENT = 100;
    ...
    constructor(
        ...
        _mint(adminWallet, _totalSupply);
    ...
    function transfer(address to, uint256 value) public returns (bool) {
        ...
        uint256 BCTokenForBurnFee = value.mul(BURN_PERCENT).div(PERCENTS_DIVIDER);
        uint256 tokensToTransfer = value
            .sub(BCTokenForMarketingFee)
            .sub(BCTokenForDevelopmentFee)
            .sub(BCTokenForBurnFee);
        ...
        emit Transfer(msg.sender, address(0), BCTokenForBurnFee);
        return true;
    }
    ...
    function transferFrom(
        ...
        emit Transfer(msg.sender, developmentWallet, BCTokenForDevelopmentFee);
        emit Transfer(msg.sender, marketingwallet, BCTokenForMarketingFee);
        emit Transfer(from, address(0), BCTokenForBurnFee);
